...
import serviceDevolucaoFornecedor from "../services/devolucaoReal.service";
...
const actions = {
  ...
  async selecionarTransportadora() {
    ...
    if (dadosTransportadoraDevolucao.TIPO_FRETE == 9) {
      dadosTransportadoraDevolucao.ESPECIE = null;
      dadosTransportadoraDevolucao.AUTORIZACAO_CORREIOS = null;
    }
